...
@Component({
  selector: 'app-alta-queja-inx',
  templateUrl: './alta-queja-inx.component.html',
  styleUrls: ['./alta-queja-inx.component.css']
})


export class AltaQuejaInxComponent implements OnInit {
...
**************************************************************************************/
  crearQueja()
  {
   this.disabled_btnCreaQueja="true";
      ...
      {
         this.variables.muestraBarra("Para crear una Incidente es necesario contar con la Información correcta","Error");
         this.disabled_btnCreaQueja="false";
         return;
      }
